 ...
 * 
 * I thought it a good implementation, so I copied it - I replaced some
 * of the Java 7 code with lambda expressions, and also reformatted the
 * entire class to reflect the rest of the code.
 */
...
public class LimitLinesDocumentListener implements DocumentListener {
     ...
     */
    public final void setLimitLines(int maximumLines) {
        if (maximumLines < 1) {
