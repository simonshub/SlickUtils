 ...
 */
package org.simon.utils.consolewindow;
 ...
 * IMPORTANT NOTE:
 * 
 * This class was copied from www.camick.com and was not written by me !
 * http://www.camick.com/java/source/MessageConsole.java
 * 
 * I thought it a good implementation, so I copied it - the only changes made were
 * strictly aesthetic; renamed the class, and reformatted the whitespaces / tabulation.
 */
...
public class ConsoleWindow {
    ...
    public ConsoleWindow(JTextComponent textComponent) {
     ...
     */
    public ConsoleWindow(JTextComponent textComponent, boolean isAppend) {
